...
export const translations: TranslationsType = {
  en: {
    ...
    "create.grade_level": "Grade Level",
    "create.topic": "Topic",
    "create.topic_placeholder": "e.g., Algebra, World War II, Photosynthesis",
    "create.question_types": "Question Types",
    "create.select_question_types": "Select at least one question type",
    "create.additional_options": "Additional Options",
    "create.test_title": "Test Title",
    "create.test_title_placeholder": "e.g., Midterm Exam, Chapter 5 Quiz",
    ...
    "create.generate_ai": "Generate with AI for",
    ...
    "section.short-answer": "Short Answer",
    "section.essay": "Essay",
    ...
    "section.matching-desc": "Match items from two columns",
    "section.fill-in-blank-desc": "Complete sentences with missing words",
  },
  ru: {
    // Navigation
    ...
    "create.subtitle": "Создайте новый тест с помощью ИИ",
    ...
    "create.browse_files": "Выбрать файлы",
    ...
    "create.select_topics": "Выберите темы, которые хотите включить в тест",
    "create.required_info": "Обязательная информация",
    ...
    "create.generate_ai": "Создать с помощью ИИ для",
    ...
    "analytics.showing_data": "Материалы для",
    ...
    "grade.middle": "Средняя школа",
    "grade.high": "Старшая школа",
    "grade.college": "Колледж",
    "grade.graduate": "Аспирантура",
    "grade.professional": "Профессиональное образование",

    // Section Types
    "section.multiple-choice": "Множественный выбор",
    "section.true-false": "Верно/Неверно",
    "section.short-answer": "Короткий ответ",
    "section.essay": "Эссе",
    ...
    "section.fill-in-blank-desc": "Заполните предложения пропущенными словами",
  },
  uz: {
    // Navigation
    ...
    "create.skip_loading": "Yuklashni o'tkazib yuborish",
    ...
    "grade.middle": "O'rta maktab",
    "grade.high": "O'rta maxsus maktab",
    "grade.college": "Kollej",
    "grade.graduate": "Magistratura",
    "grade.professional": "Professional ta'lim",

    // Section Types
    "section.multiple-choice": "Ko'p tanlovli. (a, b, c)",
    "section.true-false": "To'g'ri/Noto'g'ri",
    "section.short-answer": "Qisqa javob",
    "section.essay": "Insho",
