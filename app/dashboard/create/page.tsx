...
export default function CreatePage() {
  ...
  return (
    <div className="container mx-auto py-6">
      ...
      {error && (
        <div className="mb-4">
          <div className="flex items-center gap-2 bg-red-100 border border-red-300 text-red-700 px-4 py-2 rounded-md shadow-sm animate-shake">
            <svg
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="rounded-lg border p-6">
                      ...
                      <FormItem>
                        ...
                        >
                          <FormControl>
                            <SelectTrigger>
                              <SelectValue
                                placeholder={t("create.grade_level")}
                              />
                            </SelectTrigger>
                          </FormControl>
                          <SelectContent>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="mt-4">
                      <FormLabel>{t("create.prompt")}</FormLabel>
                      <FormControl>
                        <Textarea
