...
export default function DashboardLayout({
  ...
  // Remove client-side auth check and loading state

  // If not authenticated, don't render the dashboard (should never happen due to middleware)
  // if (!isAuthenticated) {
  //   return null;
  // }
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div
                        className="hover:cursor-pointer flex items-center gap-1.5 bg-amber-100 dark:bg-amber-950/40 text-amber-700 dark:text-amber-400 px-3 py-1.5 rounded-full font-medium text-sm transition-colors hover:bg-amber-200 dark:hover:bg-amber-950/60"
